...
All <i>send_file</i> options are available using this method. Avoid using the <b>:x_send_file</b> with this method because you're going to be mixing headers and weird things can happen.
