...
All <i>send_file</i> options are available using this method. <del>Avoid using the <b>:x_sendfile</b> with this method because you're going to be mixing headers and weird things can happen.</del> Now you can even let your old <b>:x_sendfile</b> option since the plugin will discard it.
